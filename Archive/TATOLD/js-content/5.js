document.write(`
  <nav class="navbar">
    ...
    <ul class="nav-links">
      <li>
        <a href="https://ssb.colonelvyas.org/TAT" class="nav-link">
  ...
  <main>
    <div class="intro-card" id="introCard">
      ...
      <p>Welcome to TAT Mock</p>
      
      <div class="instructions-box">
        <h2>Some Basic Instructions</h2>
        <ul>
          <li>Use full screen for best result in desktop and landscape mode in mobile device.</li>
          <li>Instructions would be shown on screen after you click on start test.</li>
        </ul>
      </div>
    ...
    <div id="videoContainer" style="display: none; background: #000; width: 100%; height: 100vh; align-items: center; justify-content: center; position: fixed; top: 0; left: 0; z-index: 9999;">
      <video id="testVideo" poster="tat-poster.png" muted style="max-width: 100%; max-height: 100vh;">
