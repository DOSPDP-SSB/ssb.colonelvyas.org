 ...
 * SRT Mock Test Interactive Controller: Dynamic Test Timer & Responsive Tools
 */
...
(function () {
  ...
  const timerWidget = document.getElementById('srtTimerWidget');
  ...
  function onTimerComplete() {
    ...
    setTimeout(function() {
      alert('⏱ Time is up! ' + testMinutes + ' minutes have elapsed for this SRT Mock Test.');
    }, 100);
  }
  ...
  if (timerCollapseBtn && timerWidget) {
    timerCollapseBtn.addEventListener('click', function (e) {
      e.stopPropagation();
      timerWidget.classList.toggle('collapsed');
      const isCollapsed = timerWidget.classList.contains('collapsed');
      timerCollapseBtn.setAttribute('title', isCollapsed ? 'Expand Timer' : 'Minimize Timer');
    });
  }
