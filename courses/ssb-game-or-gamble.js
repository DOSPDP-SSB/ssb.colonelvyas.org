 ...
 * Course Engine: The Services Selection Board: Game or Gamble
 * File: courses/ssb-game-or-gamble.js
...
(function () {
  ...
  const COURSE_MODULES = [
    { id: 'intro', title: '1. Introduction', type: 'Lesson', duration: '3 min' },
    { id: 'mvk', title: '2. Manasa-Vacha-Karma', type: 'Lesson', duration: '3 min' },
    { id: 'how-to-think', title: '3. How to Think? (Case Study)', type: 'Lesson', duration: '10 min' },
    { id: 'correct-solution', title: '4. The Correct Solution', type: 'Lesson', duration: '10 min' },
    { id: 'traits-officer', title: '5. Traits of Officer', type: 'Lesson', duration: '3 min' },
    { id: '5-days-ssb', title: '6. 5 Days of SSB', type: 'Video', duration: '27 min' },
    { id: 'hard-truth', title: '7. The Hard Truth', type: 'Tip', duration: '1 min' },
    { id: 'olq', title: '8. Officer Like Quality', type: 'Lesson', duration: '3 min' },
    { id: 'olq-video', title: '9. Officer Like Quality Video', type: 'Video', duration: '10 min' },
    { id: 'conclusion', title: "10. Conclusion & What's Next", type: 'Lesson', duration: '2 min' },
    { id: 'assessment', title: '11. Assessment Check', type: 'Assessment', duration: '3 min' }
  ];

  const TOTAL_UNITS = COURSE_MODULES.length;
  const CORRECT_QUIZ_ANSWER_INDEX = 2; // Karma (Option C)

  // --- Storage Keys ---
  const STORAGE_KEY_CURRENT = 'ssb_course_gorg_current_unit';
  const STORAGE_KEY_COMPLETED = 'ssb_course_gorg_completed_units';
  const STORAGE_KEY_NOTES = 'ssb_course_gorg_case_notes';
  ...
  function loadSavedState() {
    ...
    if (caseNotesInput && savedNotes) {
      caseNotesInput.value = savedNotes;
    }
      ...
      btnSubmitQuiz.addEventListener('click', function () {
        ...
        if (feedbackTitle) {
          feedbackTitle.innerHTML = isCorrect 
            ? '<strong>✓ Correct!</strong> Karma represents actions and deeds, which are evaluated by the GTO through practical tasks.' 
            : '<strong>✕ Incorrect.</strong> Rationale: Karma represents actions and deeds, which are evaluated by the GTO through practical tasks.';
        }
  ...
  // ==========================================================================
  // 4. Case Study Scratchpad Auto-Saver
  // ==========================================================================
  function initScratchpad() {
    ...
    caseNotesInput.addEventListener('input', function () {
      ...
      notesTimer = setTimeout(function () {
        try {
          localStorage.setItem(STORAGE_KEY_NOTES, caseNotesInput.value);
          if (scratchpadSaveStatus) {
            scratchpadSaveStatus.textContent = 'Auto-saved locally';
          }
        } catch (e) {
  ...
  // ==========================================================================
  // 8. Event Listeners & Keyboard Navigation
  // ==========================================================================
